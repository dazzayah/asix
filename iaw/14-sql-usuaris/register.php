...
<body>
<div class="container" id="login-dialog" style="padding-top: 20px">
    <form class="col-lg-4 col-lg-offset-4" style="border: 1px solid #aaa; text-align: center;" method="post">
